    ...
    <head>
        ...
        <script type="text/javascript">
            window.onload = function () {
                // Lấy giá trị totalPrice từ sessionStorage
                var totalPrice = sessionStorage.getItem('totalPrice');
                // Kiểm tra nếu giá trị tồn tại
                if (totalPrice) {
                    // Cập nhật giá trị vào trường input cho số tiền
                    document.getElementById('amount').value = totalPrice * 24000;
                }
            };
        </script>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="table-responsive">
                <form action="/Bac_Ha_Charm/vnpayajax/*" id="frmCreateOrder" method="post">        
